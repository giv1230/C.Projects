 ...
 * 
 * 
 * @function: MapResult HashMapRehash(HashMap *_map, size_t newCapacity);
 */
 ...
 *                   Iteration will stop if _action returns a zero for a given pair
...
typedef struct Map_Stats {
	size_t numberOfBuckets;	/* Amounts of lists */
	size_t numberOfChains; 	/* Amounts of lists */
